...
- $rent\_fee$ - deposit fee for storing data on chain. Detailed explanation of rent fee calculation in case of Wasm tranactions can be found under the [in the Build section](https://docs.astar.network/docs/build/wasm/transaction-fees#storage-rent).
