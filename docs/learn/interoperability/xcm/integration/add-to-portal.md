...
5. And finally, have deployed the forked app, and submitted the staging URL [ref](https://docs.astar.network/docs/build/builder-guides/integration_toolings/deploy-astar-portal).
