...
You can clone the Astar repository and run the local node provided, or download the precompiled binary and run it, instead. Both methods are described in the Astar official docs [Build](https://docs.astar.network/docs/builder-guides) section.
